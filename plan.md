...
* **Layout v2** (spec Liquid Glass derivada de design.md): botón grabar Ø104 elevado (~45% del alto desde el borde inferior, ajuste 2026-08-22 por feedback del dueño: a 30% quedaba muy bajo y el pill de historial se solapaba con la barra de gestos); tarjeta emergente glass sobre él; historial oculto tras gesto vertical (sheet glass inicial 50%, arrastrable hasta 90%).
