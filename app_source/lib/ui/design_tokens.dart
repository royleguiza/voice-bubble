...
ThemeData buildLightTheme() {
  final colorScheme = ColorScheme(
    ...
    primaryContainer: kAccentLight.withOpacity(0.12),
    onPrimaryContainer: kAccentLight,
    secondary: kAccentLight,
    onSecondary: Colors.white,
    secondaryContainer: kAccentLight.withOpacity(0.12),
    onSecondaryContainer: kAccentLight,
    tertiary: kRecording,
    onTertiary: Colors.white,
    tertiaryContainer: kRecording.withOpacity(0.12),
...
ThemeData buildDarkTheme() {
  final colorScheme = ColorScheme(
    ...
    primaryContainer: kAccentDark.withOpacity(0.15),
    onPrimaryContainer: kAccentDark,
    secondary: kAccentDark,
    onSecondary: Colors.black,
    secondaryContainer: kAccentDark.withOpacity(0.15),
    onSecondaryContainer: kAccentDark,
    tertiary: kRecordingDark,
    onTertiary: Colors.black,
    tertiaryContainer: kRecordingDark.withOpacity(0.15),
