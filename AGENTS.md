...
- [x] Lote v1.2 – Configuración con Tabs C2, Tecla Micrófono M4 Morph-to-Pill y APK split arm64 (2026-08-24, `plan-v1.2.md`, auditado en MODO-LOOP >9.0): Settings con 4 tabs glass inferiores (`IndexedStack` que preserva estado + 96dp bottom padding); tecla mic M4 en teclado nativo Kotlin con expansión a pastilla roja, punto pulsante, cronómetro M:SS y touch target cancelar >=44dp; optimización de CI a split arm64 (-67% de peso, 168MB -> 48MB en storage GitHub). CI verde a la primera: run [`32679923216`](https://github.com/royleguiza/voice-bubble/actions/runs/32679923216) success · artefacto `voice-bubble-arm64-debug-apk-r63` (48.35 MB comprimido).

**Siguiente etapa**: verificación del dueño en dispositivo con el APK r63 (`voice-bubble-arm64-debug-apk-r63`).
